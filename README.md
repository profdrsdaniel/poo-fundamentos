...
├── aula02/     Arrays, laços e métodos: estatísticas de uma turma
...
| 02 | `task/estatisticas` | Arrays, laços e decomposição em métodos | [ver branch](https://github.com/profdrsdaniel/poo-fundamentos/tree/task/estatisticas) |
